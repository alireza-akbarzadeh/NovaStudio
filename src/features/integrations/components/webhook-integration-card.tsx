...
import { HashIcon, Loader2Icon, MessageCircleIcon } from "lucide-react";
...
} from "@/features/integrations/hooks/use-integration-connection";
...
export function WebhookIntegrationCard({
  ...
  const {
    ...
    connect,
    disconnect,
  } = useIntegrationConnection(provider);
