...
export function WorkspacePublishMenu({ projectId }: WorkspacePublishMenuProps) {
  ...
  const onDeploy = (provider: DeployProvider) => {
    ...
    void deploy(provider, "production");
  };
  ...
  return (
    <>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              ...
              >
                {isPublishing || deployingProvider ? (
                  <Loader2Icon
          ...
          {isGitHub && project.githubRepoUrl ? (
            <>
              ...
              >
                ...
                {vercel.isConnected
                  ? "Deploy to Vercel"
                  : "Connect & deploy Vercel"}
              </DropdownMenuItem>
              <DropdownMenuItem
                className="text-[12px] focus:bg-ws-hover focus:text-ws-text"
                asChild
              >
                <a href="/projects/integrations">
                  <ExternalLinkIcon className="size-3.5" />
                  Manage integrations
                </a>
              </DropdownMenuItem>
      ...
      <ConnectDeployDialog
        provider={connectProvider ?? "vercel"}
